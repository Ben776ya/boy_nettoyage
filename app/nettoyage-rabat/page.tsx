...
export const metadata: Metadata = {
  ...
  description: `BOY NETTOYAGE PRO, société de nettoyage professionnelle à ${city.city}. Appartements, villas, bureaux, dératisation. Équipe qualifiée, devis gratuit sous 24h. ☎ +212 6 61 40 85 77`,
  keywords: [
  ...
  openGraph: {
    ...
    description: `Société de nettoyage professionnel à ${city.city}. Appartements, villas, bureaux, dératisation. Devis gratuit sous 24h.`,
