...
const city = getCityBySlug("nettoyage-agadir")!;

export const metadata: Metadata = {
  title: `Société de Nettoyage ${city.city} — BOY NETTOYAGE PRO | Devis Gratuit`,
  description: `BOY NETTOYAGE PRO, société de nettoyage professionnelle à ${city.city}. Résidences balnéaires, villas, hôtels, bureaux, dératisation. Devis gratuit sous 24h. ☎ +212 6 61 40 85 77`,
  keywords: [
    ...
    `nettoyage résidences ${city.city.toLowerCase()}`,
  ...
  openGraph: {
    ...
    description: `Société de nettoyage professionnel à ${city.city}. Résidences, villas, hôtels, bureaux, dératisation. Devis gratuit sous 24h.`,
...
export default function NettoyageAgadirPage() {
  return (
    <>
      <script
